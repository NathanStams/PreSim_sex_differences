...
S.weights.a = 2000; % Reduced to half of the original cost, as this weight is multiplied by a sum over twice as many activations.
...
S.subject.tendon_stiff_scale = {{'soleus','_gas'},0.39};
%Quadriceps muscle tendon stiffnes decreased by 70% from default
S.subject.tendon_stiff_scale = {{'rect_fem','vas_med', 'vas_lat', 'vas_int'},0.70};
