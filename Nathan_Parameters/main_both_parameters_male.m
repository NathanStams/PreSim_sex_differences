...
S.subject.tendon_stiff_scale = {{'soleus','_gas'},0.6};
%Quadriceps muscle tendon stiffness not decreased from default. 
%S.subject.tendon_stiff_scale = {{'rect_fem','vas_med', 'vas_lat', 'vas_int' },1.0};
