...
S.bounds.distanceConstraints(6).point1 = 'tibia_r';
S.bounds.distanceConstraints(6).point2 = 'tibia_l';
S.bounds.distanceConstraints(6).direction = 'xz';
S.bounds.distanceConstraints(6).lower_bound = 0.11;
