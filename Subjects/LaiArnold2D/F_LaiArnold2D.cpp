...
int F_generic(const T** arg, T** res) {
	...
	ground_pelvis = new OpenSim::PinJoint("ground_pelvis", model->getGround(), Vec3(-0.16418680684476588683, 0.79243081323333364185, 0.00000000000000000000), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), *pelvis, Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000));

	OpenSim::PinJoint* hip_r;
	hip_r = new OpenSim::PinJoint("hip_r", *pelvis, Vec3(-0.05627613893487593000, -0.07849019377707036615, 0.07726019074043133372), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), *femur_r, Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000));
	...
	hip_l = new OpenSim::PinJoint("hip_l", *pelvis, Vec3(-0.05627613893487593000, -0.07849019377707036615, -0.07726019074043133372), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), *femur_l, Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000));
	...
	Vec3 Force_pedal_force_r;	for (int i = 0; i < 3; ++i) Force_pedal_force_r[i] = u[7+i];
	...
	Vec3 Force_pedal_force_l;	for (int i = 0; i < 3; ++i) Force_pedal_force_l[i] = u[10+i];
	...
	for (int i = 0; i < 3; ++i) res[0][i + nCoordinates + 6] = value<T>(pedal_r_velInGround[i]);
	for (int i = 0; i < 3; ++i) res[0][i + nCoordinates + 9] = value<T>(pedal_l_velInGround[i]);
